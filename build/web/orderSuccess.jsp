...
<html lang="en">
    ...
    <body style="background-image: linear-gradient(to right bottom, #416960, #66877f)">
        <p></p>
        <!-- navigation panel -->
        ...
        <div  id="EmptyCard" >
            ...
            <span class="glyphicon glyphicon-ok" style="font-size: 250px; align-content: center; color:lightskyblue; text-align:center; "></span>
            <br></br>
            <p style="font-size: 34px; color:#8e9191; ">Thank you for your order</p>
            <form name="" method="post" action="orderHistory.jsp" id="contactForm" novalidate>
                <button type="submit" value="" class="btn btn-info">Show your products</button>
            </form>
        </div>    
